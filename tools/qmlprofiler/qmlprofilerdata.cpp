...
template<typename SendEvent>
void DataIterator<SendEvent>::handleRangeEvent(
...
template<typename SendEvent>
void DataIterator<SendEvent>::sendPending()
{
...
template<typename SendEvent>
void DataIterator<SendEvent>::endLevel0()
{
    sendPending();
    for (qsizetype i = 0; i < MaximumRangeType; ++i) {
        rangeStarts[i].clear();
...
template<typename SendEvent>
void DataIterator<SendEvent>::run()
{
